<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GuestMyBookings.aspx.cs"
    Inherits="Respace.GuestMyBookings" MasterPageFile="~/Site.Master" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:GridView ID="gv" runat="server" AutoGenerateColumns="false" DataKeyNames="BookingId"
        ...
        <Columns>
            <asp:BoundField DataField="Name" HeaderText="Space" />
            ...
            <asp:TemplateField HeaderText="Cancel">
                <ItemTemplate>
                    <asp:Panel runat="server" Visible='<%# Eval("Status").ToString() == "Confirmed" %>'>
                        <asp:TextBox ID="txtReason" runat="server" Width="220" Placeholder="Reason (optional)" />
